...
class Cluster(object):
    ...
    def singleLinkageDist(self, other):
        ...
        for m in self.members():
            for om in other.members():
                m_dist = m.distance(om)
                if dist > m_dist or dist is None:
                    dist = m_dist
    ...
    def averageLinkageDist(self, other):
        ...
        for m in self.members():
            for om in other.members():
                distances.append(m.distance(om))
...
class ClusterSet(object):
    ...
    def mergeClusters(self, c1, c2):
        ...
        merge_points = [p for p in c1.members()] + [p for p in c2.members()]
        merge_cluster = Cluster(merge_points, c1.pointType)
        self.members.append(merge_cluster)
...
def test():
    points = buildCityPoints('/home/zen/code/edx.computational.thinking/Week6/cityTemps.txt', False)
